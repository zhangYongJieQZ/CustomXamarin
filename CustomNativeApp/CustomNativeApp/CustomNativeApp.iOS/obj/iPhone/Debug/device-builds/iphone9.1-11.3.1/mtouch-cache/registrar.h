...
@class CustomNativeApp_iOS_CustomTabbedPageRenderer;
@class Xamarin_Forms_Platform_iOS_NavigationRenderer;
@class CustomNativeApp_iOS_CustomNavigationPageRenderer;
...
@interface CustomNativeApp_iOS_CustomTabbedPageRenderer : Xamarin_Forms_Platform_iOS_TabbedRenderer {
}
	-(id) init;
@end
...
@interface CustomNativeApp_iOS_CustomNavigationPageRenderer : Xamarin_Forms_Platform_iOS_NavigationRenderer {
}
	-(id) init;
@end
