...
extern void *mono_aot_module_CustomNativeApp_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_CustomNativeApp_info;
...
extern void *mono_aot_module_Zhangyongjie_CustomKit_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_CustomNativeApp_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_CustomNativeApp_info);
	...
	mono_aot_register_module (mono_aot_module_Zhangyongjie_CustomKit_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CustomNativeApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
